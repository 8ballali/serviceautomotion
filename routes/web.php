...
Route::group(['middleware' => ['Admin']], function () {
    Route::GET('/pdf',[BookingController::class,'exportPDF'])->name('booking.pdf');
    ...
    Route::GET('/booking/bukti/download/{booking_id}',[BookingController::class,'download'])->name('booking.download');
